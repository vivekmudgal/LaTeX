...
\item Part of a Gold winning team which designed a attachment to increase the utility of an ordinary wheelchair
\end{rSubsection}

\begin{rSubsection}{JEE Advanced}{June 2015}{}{}
\item Secured an All India Rank of 975 in JEE Advanced, 2015 among those who qualified with a percentile of 99.5%
\end{rSubsection}
\end{rSection}
...
\\ \itab{Electrical Machines} \tab{}  \tab{Control Systems Engineering}
\\ \itab{Analog Electronics} \tab{}  \tab{Linear Algebra} 
\\ \itab{Signals \& Networks} \tab{}  \tab{Digital Electronics} 
\\ \itab{Introduction to Elctronics} \tab{} \tab{Power Electronics}
\\ \itab{Transform Calculus}  
